...
theorem QuantumParallelRepetition.common_finite_purification_pair_jensen
    {ι κ d : Type*}
    ...
    ((∑ a : ι, weight a •
      ...
      (∑ a : ι, weight a •
        ((finitePurificationMatrix F anchor positive hanchor (choose a) -
          ...
          (finitePurificationMatrix F anchor positive hanchor (choose a) -
            finitePurificationMatrix F anchor positive hanchor meanIndex)))).PosSemidef := by sorry
